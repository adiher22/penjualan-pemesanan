       ...
       <div class="container">
         <div class="row align-items-center row-login">
           <div class="col-lg-6 text-center">
             <img src="<?= site_url('assets/front-end/images/undraw_my_password_d6kg.svg') ?>" alt="" class="w-50 mb-4 mb-lg-none">
           </div>
           <div class="col-lg-5">
             <h2>
             ...
             <form action="<?= site_url('auth/proses') ?>" method="POST" class="mt-3">
              ...
              <div class="form-group">
                ...
                <input type="password" name="passconf" class="form-control w-75" required>
              </div>
              <div class="form-group">
                <span>*Masukan password dengan benar <br> dan mudah diingat anda!</span>
              </div>
              <button type="submit" class="btn btn-primary btn-block w-75 mt-4">Reset Password</button>
