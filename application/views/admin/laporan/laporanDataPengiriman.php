<div class="content-wrapper">
    ...
    <div class="content d-flex justify-content-center">
        <div class="col-sm-6">
            ...
            <!-- /.card-header -->
            <!-- form start -->
                    <form action="<?= site_url('admin/laporan/LaporanDataPengiriman') ?>" method="post">
                    <div class="card-body">
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Pengiriman Dari Tanggal : <?= indo_date($this->input->post('dari')) ?>, Sampai Tanggal: <?= indo_date($this->input->post('sampai')) ?></h3>
               <div class="col-6 ml-auto mr-0">
               <a href="<?= site_url('admin/laporan/cetakPengiriman'.'?dari='.set_value('dari').'&sampai='.set_value('sampai')) ?>" target="_blank" class="btn btn-success float-right"><i class="fa fa-print"></i> Print</a>
               </div> 
              </div>
              ...
              <div class="card-body">
                <table id="" class="table table-bordered table-striped">
                  ...
                  <?php $no = 1;
                    foreach($report as $r) {
                     if($r->bukti_bayar!=null && $r->status_pemesanan == "DIKIRIM") { ?>
                  <tr>
                    ...
                    <td class="text-center"><?= $r->no_resi?></td> 
