...
// 	{
// 		$id = $this->session->userdata('wargaid');
		
// 		$data['title'] = "Halaman Dashboard Warga";
...
// 	   $warga_id = $this->session->userdata('wargaid');
    

// 	   $valid = $this->form_validation;

// 	   $valid->set_rules('nama', 'Nama Warga', "required|min_length[5]|max_length[50]|regex_match[/[a-zA-Z]+$/]", 
...
// 	   if($valid->run()===FALSE) {
// 		 $data = [   'title' => 'Halaman Profile Warga',
// 					 'row'   => $this->M_warga->get($warga_id)->row()
